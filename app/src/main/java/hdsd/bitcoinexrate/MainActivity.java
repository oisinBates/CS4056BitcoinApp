...
//bitcoin drawable sourced from www.bitcoin.org
...
public class MainActivity extends Activity {
    ...
    private String url = "https://www.bitstamp.net/api/ticker_hour/";


    private static String TAG = MainActivity.class.getSimpleName();
    private ImageButton btnNoteTaker, btnGraph, btnSettings;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNoteTaker = (ImageButton) findViewById(R.id.btnObjRequest1);
        ...
        btnNoteTaker.setOnClickListener(new View.OnClickListener() {
    ...
    private void makeJsonObjectRequest() {
        ...
        hdsd.bitcoinexrate.AppController.getInstance().addToRequestQueue(jsonObjReq);
    }
